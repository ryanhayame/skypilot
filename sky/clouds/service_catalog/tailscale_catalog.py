...
get_image_id_from_tag = kubernetes_catalog.get_image_id_from_tag
is_image_tag_valid = kubernetes_catalog.is_image_tag_valid
...
def validate_region_zone(
    ...
    # TODO(asaiacai): get list of clusters in tailnet
